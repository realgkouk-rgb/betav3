...
local FRUIT_KEYWORDS = {"fruit ", "venom fruit", "t-rex fruit", "spirit fruit", "kitsune fruit", "gravity fruit", "shadow fruit", "control fruit", "quake fruit", "spider fruit", "lighting fruit", "phoenix fruit", "creation fruit", "love fruit", "blizzard fruit", "sound fruit", "buddha fruit", "light fruit", "magma fruit", "ghost fruit", "rubber fruit", "ice fruit", "diamond fruit", "dark fruit", "eagle fruit", "flame fruit", "sand fruit", "spin fruit", "smoke fruit", "spring fruit", "blade fruit", "spike fruit", "rocket fruit", "bomb fruit", "pain fruit", "portal fruit", "mammoth fruit", "dough fruit", "gas fruit", "tiger fruit", "yeti fruit", "dragon (west) fruit", "dragon (east) fruit"}
...
_G.GkoukHubCleanup = function()
	...
	-- Clear normal ESP (highlights, billboards, distance connections)
	pcall(removeESP)
	...
	-- Destroy water platform if active
...
waterBtn.MouseButton1Click:Connect(function()
	...
	if waterWalkEnabled then
		...
		-- Create a massive invisible platform covering the whole map
		-- Y = 3 so it sits above the water surface
		waterPlatform = Instance.new("Part")
		waterPlatform.Name = "WaterWalkPlatform"
		waterPlatform.Size = Vector3.new(10000, 0.12, 10000)
		waterPlatform.Anchored = true
		waterPlatform.Transparency = 1
		waterPlatform.CanCollide = true
		waterPlatform.Position = Vector3.new(0, 3, 0)
